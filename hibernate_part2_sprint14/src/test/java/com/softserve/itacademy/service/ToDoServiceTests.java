...
public class ToDoServiceTests {
    ...
    public void createToDoTest() {
        ...
        expected.setTitle("Mike's To-DO #4");
    ...
    public void readByIdTest() {
        ...
        LocalDate expectedDate = expected.getCreatedAt().toLocalDate();
        ToDo actual = toDoService.readById(21);

        LocalDate actualDate = actual.getCreatedAt().toLocalDate();
    ...
    public void exceptionWhenReadByNoneExists() {
        ...
        String expectedMessage = "Todo with id " + id + " does not exists";
